      ...
      <TextContainer>
        <div>
          ...
          <SocialList>
            <li>
              <a
                href="https://gitlab.com/UddeshJain"
                target="_blank"
            ...
            <li>
              <a
                href="https://github.com/UddeshJain"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://www.linkedin.com/in/uddeshjain/"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
            ...
            <li>
              <a
                href="https://stackoverflow.com/users/8971995/uddesh-jain"
                target="_blank"
                rel="noopener noreferrer"
              >
                <svg
